...
DEFAULT_EXPECTATIONS: dict[str, dict[str, Any]] = {
    ...
    "persia": {"spawnRateMin": 0.90, "medianMaxCitiesMin": 5, "note": "Should rise to a regional power at peak; floor relaxed 10->5 to allow believable rise-and-fall (peaks ~6, then declines) instead of assuming a permanent megaempire."},
    "rome": {"spawnRateMin": 0.90, "medianMaxCitiesMin": 5, "note": "Should rise to a regional power at peak; floor relaxed 10->5 to allow believable rise-and-fall (peaks ~7, then declines) instead of assuming a permanent megaempire."},
